            ...
            <form name="inputform" action="update.do" method="post">
             ...
             <div class="input_set">
             	<div class="input_1">
                  ...
                  <div class="just_cont">
                    <input type="text" name="btitle" style="width: 100%; height: 40px; border: none;" value="${dto.getBtitle()}">
                  </div>  
                </div>
                ...
                <div class="input_set">
             	<div class="input_1">
                  ...
                  <div class="just_cont">
                    <input type="text" name="bname" style="width: 100%; height: 40px;  border: none;" value="${dto.getBname()}">
                  </div>  
                </div>
