          ...
          <h1>공지사항 등록</h1>
            ...
            <div class="input_set">
                <div class="input_1">
                  ...
                  <div class="just_cont">
                    <input type="text" name="bname" style="border: 1px solid #dddddd;height: 50px;width: 200px;">
                  </div>  
                </div>
             </div>  
               <div class="input_set">
                <div class="input_1">
                  ...
                  <div class="just_cont">
                    <div class="just_cont">
                    	<input type="text" name="btitle"  style="border: 1px solid #dddddd;height: 50px;width: 700px;">
                  	</div>
                  </div>  
                </div>
               </div> 
             <div class="input_set">
                <div class="input_1">
                  ...
                  <div class="just_cont">
                    <textarea id="txt_wr" name="bcontent" cols="127" rows="10" maxlength="1000" placeholder="내용을 입력해주세요"></textarea>
