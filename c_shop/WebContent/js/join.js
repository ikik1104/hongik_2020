 ...
 */
	...
	function id_ch(){
		window.open("join_id_pop.jsp", "id_check", "width=600, height=400px, resizable=no, scrollbars=no");
	}
	...
	function check(){
		...
		//모두 통과하면 합치기
		join.birth.value = $("#year").val()+"/"+$("#month").val()+"/"+$("#day").val();
